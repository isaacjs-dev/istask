  ...
  <div class="auth-split">
    ...
    <div class="auth-right">
      <div class="auth-form-wrap">
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="fld">
            <div class="row">
              ...
              <a class="link" href="{{ route('home') }}" title="Recuperação de senha em breve">Esqueci minha senha</a>
            </div>
            <div class="input">
        ...
        <button class="btn-oauth" type="button" disabled title="Login com Google em breve">
          ...
          Google <span class="soon">(em breve)</span>
        </button>
